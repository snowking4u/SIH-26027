...
class BlockPlan(Base):
    ...
    revises_plan_id: Mapped[int | None] = mapped_column(
    ...
    revises_plan = relationship(
        "BlockPlan",
        remote_side=[id],
        back_populates="revised_plans",
    )
    revised_plans = relationship(
        "BlockPlan",
        back_populates="revises_plan",
