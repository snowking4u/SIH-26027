...
const LAUNCH_TARGETS: LaunchTarget[] = [
  { label: "Engineering", path: "/departments/engineering", icon: Wrench },
  { label: "S&T", path: "/departments/snt", icon: ListChecks },
  { label: "Traction", path: "/departments/traction", icon: Undo2 },
